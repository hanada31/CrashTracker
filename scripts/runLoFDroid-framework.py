...
if __name__ == '__main__' :
    ...
    command = "java -jar "+jarFile+"  -path "+ path +" -name "+name+" -androidJar "+ sdk +"/platforms -client ExceptionInfoClient " +" -outputDir Files/ "  +" -AndroidOSVersion " + sys.argv[1] +" >> Files/logs/android-" +sys.argv[1]+".txt"
    executeCmd(command)

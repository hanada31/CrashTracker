...
public class BuggyStatistic {
    ...
    private void analyzeAllFiles() {
        FileUtils.writeText2File( "Files" + File.separator+"VarTypeStatistic.txt", "", false);
        FileUtils.writeText2File( "Files" + File.separator+"RankingStatistic-Category.txt", "", false);
        FileUtils.writeText2File( "Files" + File.separator+"RankingStatistic-RVType.txt", "", false);
        String[] fns = {};
...
//        CandiAvg_base = 0;
    ...
    private void printRankInfo2SB(String tag, Map<String, Integer> map, StringBuilder sb, double MRR) {
        ...
        if(tag.equals("All")){
            r1 = 500; r5 = 562; r10 = 567; mrr= 0.907;
